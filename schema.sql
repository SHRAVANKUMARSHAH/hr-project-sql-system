...
UPDATE departments SET manager_id = 4 WHERE dept_id = 1; 
UPDATE departments SET manager_id = 3 WHERE dept_id = 4; 
UPDATE departments SET manager_id = 5 WHERE dept_id = 3;
...
CREATE TABLE leave_requests (
	...
	status VARCHAR(20) CHECK (status IN ('Pending' , 'Approve' , 'Rejected')) DEFAULT 'Pending'
);